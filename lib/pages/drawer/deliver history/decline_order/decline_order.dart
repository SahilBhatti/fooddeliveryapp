...
import 'package:demoapp/pages/drawer/deliver%20history/decline_order/declineModal.dart';
...
class DeclineOrder extends StatefulWidget {
  const DeclineOrder({Key? key}) : super(key: key);
      ...
      children: [
        ...
        Scaffold(
          ...
          appBar: AppBar(
            ...
            elevation: 0.5,
            centerTitle: true,
            title: Text("Invoice history",style: appbarText,),
            leading: IconButton(
                icon: Icon(Icons.arrow_back_ios), iconSize: 18.0, onPressed: () {   Navigator.of(context).pop(true);}),
          ),
          body:
            ...
            children: [
              ...
              Column(
                  children: [
                    ...
                    Container(
                      child: (DeclineOrderModel.orderStatus.isNotEmpty)
                          ? ListView.separated(
                          shrinkWrap: true,
                          ...
                          itemCount: DeclineOrderModel.orderStatus.length,
                          itemBuilder: (BuildContext context, int index) =>
                              OrderStatus(
                                  item: DeclineOrderModel.orderStatus[index]))
