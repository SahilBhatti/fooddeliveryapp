...
void main() => runApp(const Motorcycle());
...
class Motorcycle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      title: appTitle,
      home: MotorCycleScreen(title: appTitle),
    );
  }
}

class MotorCycleScreen extends StatefulWidget {
  const MotorCycleScreen({Key? key, required this.title}) : super(key: key);
            ...
            Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    'Please Upload Transport Registration Certificate Below',
